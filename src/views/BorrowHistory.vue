...
<template>
  <v-container fluid class="py-8 px-4 px-md-12 px-lg-16 bg-grey-lighten-4">
    ...
    <v-row class="mb-6">
      <v-col cols="12">
        ...
        <p class="text-body-1 text-grey-darken-1 ml-14">
          Quản lý và theo dõi các sách bạn đã mượn
        </p>
      </v-col>
    </v-row>
      ...
      <v-col cols="12">
        <v-card class="text-center py-16" elevation="2" rounded="lg">
          <v-icon size="120" color="grey-lighten-1"
            >mdi-book-remove-outline</v-icon
          >
        ...
        <v-card elevation="2" rounded="lg">
          ...
          <v-card-text class="pa-0">
            <v-list lines="two" class="pa-0">
              <template
                v-for="(record, index) in borrowRecordStore.borrowRecords"
                :key="record?._id"
              >
                    ...
                    <v-avatar size="80" rounded="lg" class="mr-4">
                      ...
                      >
                        <template v-slot:error>
                          <v-img cover src="/imgs/no-cover.png" />
                        </template>
                      </v-img>
                    </v-avatar>
                  </template>
                    ...
                    <div class="d-flex flex-wrap flex-row ga-4 mt-2">
                      ...
                      <div class="d-flex align-center">
                        ...
                        <span class="text-caption">
                          Ngày yêu cầu:
                          <strong>{{ formatDate(record?.NGAYYEUCAU) }}</strong>
                        </span>
                      </div>
                      ...
                      <div class="d-flex align-center">
                        ...
                        <span class="text-caption">
                          Hạn trả:
                          <strong>{{ formatDate(record?.HANTRA) }}</strong>
                        </span>
                      </div>
                      ...
                      <div class="d-flex align-center">
                        ...
                        <span class="text-caption">
                          Ngày trả:
                          <strong>{{ formatDate(record?.NGAYTRA) }}</strong>
                        </span>
                      </div>
                    </div>
                  </v-list-item-subtitle>
                ...
                <v-divider
                  v-if="index < borrowRecordStore.borrowRecords.length - 1"
                ></v-divider>
              </template>
            </v-list>
          </v-card-text>
  ...
  >
    <v-card>
      ...
      <v-card-actions class="justify-end">
        <v-btn variant="elevated" color="primary" @click="cancelRequest">
          Hủy yêu cầu
        </v-btn>
  ...
  >
    <v-card>
      ...
      <v-card-actions class="justify-end">
        <v-btn variant="elevated" color="primary" @click="borrowAgain">
          Mượn sách
        </v-btn>
